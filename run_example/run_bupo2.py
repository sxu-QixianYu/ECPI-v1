...
from offlinerlkit.dynamics import EnsembleDynamicsCopy
...
from offlinerlkit.policy_trainer import MBPolicyTrainer, UNPolicyTrainer
from offlinerlkit.policy import MOUN4Policy,MOUN3Policy

def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--algo-name", type=str, default="ecpi")
    ...
    parser.add_argument("--prdc", type=float, default=0.5)
    ...
    parser.add_argument("--for-num", type=int, default=10)
...
def train(args=get_args()):
    ...
    dynamics = EnsembleDynamicsCopy(
        dynamics_model, # dong tai mo xing
        dynamics_optim, #you hua qi
        scaler,
        termination_fn,
